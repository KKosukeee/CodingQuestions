"""
Solution for 735. Asteroid Collision
https://leetcode.com/problems/asteroid-collision/
"""

class Solution:
    """
    Runtime: 56 ms, faster than 88.84% of Python3 online submissions for Asteroid Collision.
    Memory Usage: 14.1 MB, less than 5.00% of Python3 online submissions for Asteroid Collision.
    """
    def asteroidCollision(self, asteroids):
        ...
        Args:
            asteroids: list of integers representing asteroids

        Returns:
            list<int>: asteroids remained after the collisions
        """
        stack = []
        for asteroid in asteroids:
            # asteroid is moving toward right
            if asteroid > 0:
                stack.append(asteroid)
            # asteroid is moving toward left
            else:
